...
var qaeApi = /** @class */ (function () 
{
    ...
    qaeApi.prototype.createMintJson = function (tokenId = '', transactionNote = '')
    {
    ...
    qaeApi.prototype.createBurnJson = function (tokenName = '', tokenTicker = '', tokenQuantity = 0, tokenDecimals = 8, tokenUri = '', tokenNote = '', tokenPausable = false, tokenMintable = false)
    {
    ...
    qaeApi.prototype.createSendJson = function (tokenName = '', tokenTicker = '', tokenQuantity = 0, tokenDecimals = 8, tokenUri = '', tokenNote = '', tokenPausable = false, tokenMintable = false)
    {
    ...
    qaeApi.prototype.createPauseJson = function (tokenName = '', tokenTicker = '', tokenQuantity = 0, tokenDecimals = 8, tokenUri = '', tokenNote = '', tokenPausable = false, tokenMintable = false)
    {
    ...
    qaeApi.prototype.createResumeJson = function (tokenName = '', tokenTicker = '', tokenQuantity = 0, tokenDecimals = 8, tokenUri = '', tokenNote = '', tokenPausable = false, tokenMintable = false)
    {
    ...
    qaeApi.prototype.createNewOwnerJson = function (tokenName = '', tokenTicker = '', tokenQuantity = 0, tokenDecimals = 8, tokenUri = '', tokenNote = '', tokenPausable = false, tokenMintable = false)
    {
